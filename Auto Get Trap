...
Section:CreateButton("Tp to Safespot",function()
  ...
  Section:CreateToggle("Trap Fram", function(bool)
  ...
  Section:CreateToggle("Trap Timer", function(Trap)
...
if game.Players.LocalPlayer.leaderstats.Glove.Value == "Brick" and game.Players.LocalPlayer.Character.Ragdolled.Value then
